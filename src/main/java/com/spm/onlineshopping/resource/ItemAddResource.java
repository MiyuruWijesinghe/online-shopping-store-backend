...
public class ItemAddResource {
	...
	@Valid
	private List<ItemAttributeValueAddResource> itemAttributes;
	...
	public List<ItemAttributeValueAddResource> getItemAttributes() {
		return itemAttributes;
	}

	public void setItemAttributes(List<ItemAttributeValueAddResource> itemAttributes) {
